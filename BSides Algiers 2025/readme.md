...
body {
  animation: bsides-fade-in 0.5s ease-out;
}
...
.bsides-hero::before {
  ...
  animation: bsides-hero-orbit 18s linear infinite;
  pointer-events: none;
}
...
article h3::after {
  ...
  animation: bsides-heading-glow 1.2s ease-out forwards;
}
...
.bsides-nav-chip::after {
  display: none !important;
}

.bsides-nav-chip:hover {
  transform: translateY(-1px);
...
<section class="bsides-hero">
  <div class="bsides-hero-title">BSides Algiers 2025</div>
  <div class="bsides-hero-subtitle">
    Personal writeups for BSides Algiers 2025. Blockchain and crypto challenges.
  </div>

  <div class="bsides-hero-meta">
    <div class="bsides-pill">BSides Algiers 2025</div>
    <div class="bsides-pill">Per-challenge writeups</div>
    <div class="bsides-pill">Tech: Solidity · Python</div>
  </div>
</section>

## Navigation

<div class="bsides-nav">
  <a class="bsides-nav-chip" href="#blockchain">Blockchain</a>
  <a class="bsides-nav-chip" href="#crypto">Crypto</a>
</div>
...
<div class="challenge-list">
  ...
  <div class="challenge-row">
    ...
    <div class="challenge-actions">
      <a class="challenge-btn" href="./BSides%20Only-invited%20party/">README</a>
    </div>
  </div>
  <div class="challenge-row">
    <div class="challenge-name">BSides Only-invited party REVENGE</div>
    <div class="challenge-actions">
      <a class="challenge-btn" href="./BSides%20Only-invited%20party%20REVENGE/">README</a>
    </div>
  </div>
</div>
...
<div class="challenge-list">
  ...
  <div class="challenge-row">
    ...
    <div class="challenge-actions">
      <a class="challenge-btn" href="./Genie/">README</a>
    </div>
  </div>
</div>
